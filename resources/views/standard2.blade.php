...
<div class="page-header">
    <h1>Lot Info Report :: Raw LotInfo Data 2</h1>
        ...
        <form data-search data-grid="standard" class="form-inline" role="form">
            ...
            <div class="form-group">
                ...
                <select name="column" class="form-control">
                    ...
                    <option value="info.lot_num">Lot #</option>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped table-bordered table-hover" data-source="{{ URL::to('source2') }}" data-grid="standard">
                ...
                <tr>
                    ...
                    <th class="sortable" data-grid="standard" data-sort="statusname">Status</th>
                    ...
                    <th class="sortable" data-grid="standard" data-sort="buildlabel">Build Type</th>
                    ...
                    <th class="sortable" data-grid="standard" data-sort="info.notes">Notes</th>
                    <th class="sortable" data-grid="standard" data-sort="info.builder_date">Builder Date</th>
                    <th class="sortable" data-grid="standard" data-sort="info.adjust_date_to">Adjust Date To</th>
                    <th class="sortable" data-grid="standard" data-sort="info.created_at">Last Updated</th>
                    <th class="sortable" data-grid="standard" data-sort="info.verify_no_update">No Update Flag</th>
                    <th class="sortable" data-grid="standard" data-sort="username">Updated By</th>
