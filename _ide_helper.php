 ...
 * Generated for Laravel 5.2.20 on 2016-02-23.
 *
...
namespace {
    ...
    class DataGrid extends \Cartalyst\DataGrid\Laravel\Facades\DataGrid{
         ...
         * @static 
         */
        public static function make($dataHandler, $columns, $settings = array(), $transformer = null){
            return \Cartalyst\DataGrid\Environment::make($dataHandler, $columns, $settings, $transformer);
        }
         ...
         * @static 
         */
        public static function createDataGrid($dataHandler, $columns, $settings = array(), $transformer = null){
            return \Cartalyst\DataGrid\Environment::createDataGrid($dataHandler, $columns, $settings, $transformer);
        }
        ...
        public static function getRequestProvider(){
            return \Cartalyst\DataGrid\Environment::getRequestProvider();
        }
         ...
         * @static 
         */
        public static function setDataHandlerMappings($mappings){
            \Cartalyst\DataGrid\Environment::setDataHandlerMappings($mappings);
        }
